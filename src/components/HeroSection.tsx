    ...
    <div className="relative min-h-[90vh] bg-white flex items-center overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        <div className="bg-california-road-lighter absolute inset-0 bg-fixed">
          ...
          <div className="absolute top-1/4 left-1/3 w-24 h-24 rounded-full bg-chargetrux-green/20 animate-pulse"></div>
          <div className="absolute bottom-1/3 right-1/4 w-32 h-32 rounded-full bg-chargetrux-blue/20 animate-pulse" style={{ animationDelay: "1s" }}></div>
          
          {/* Charging indicator */}
          <div className="absolute bottom-8 right-8 backdrop-blur-lg bg-white/70 text-chargetrux-darkblue p-4 rounded-xl shadow-lg border border-chargetrux-green/20 z-20">
      ...
      <div className="container mx-auto px-4 md:px-6 z-10">
        <div className="flex flex-col md:flex-row items-center gap-8">
          <motion.div 
            className="w-full md:w-3/5 text-chargetrux-darkblue space-y-6 md:pr-12 mb-8 md:mb-0"
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4 pt-2">
              ...
              <Button variant="outline" size="lg" className="bg-transparent border-chargetrux-darkblue text-chargetrux-darkblue hover:bg-chargetrux-darkblue/10 rounded-md">
                Fleet Overview PDF
              </Button>
            </div>
          </motion.div>
              ...
              <div className="relative bg-white/70 backdrop-blur-sm border border-chargetrux-green/20 rounded-xl p-6 shadow-xl">
                ...
                <ul className="space-y-3">
                  <li className="flex items-center gap-3">
                    ...
                    <span className="text-chargetrux-darkblue">Level 3 DC Fast Charging</span>
                  </li>
                  <li className="flex items-center gap-3">
                    <div className="bg-chargetrux-green/20 p-1.5 rounded-md">
                      <Zap className="h-4 w-4 text-chargetrux-green" />
                    </div>
                    <span className="text-chargetrux-darkblue">Multi-vehicle support</span>
                  </li>
                  <li className="flex items-center gap-3">
                    <div className="bg-chargetrux-green/20 p-1.5 rounded-md">
                      <Zap className="h-4 w-4 text-chargetrux-green" />
                    </div>
                    <span className="text-chargetrux-darkblue">24/7 mobile availability</span>
                  </li>
                  <li className="flex items-center gap-3">
                    <div className="bg-chargetrux-green/20 p-1.5 rounded-md">
                      <Zap className="h-4 w-4 text-chargetrux-green" />
                    </div>
                    <span className="text-chargetrux-darkblue">Fleet management software</span>
                  </li>
                </ul>
              </div>
            </div>

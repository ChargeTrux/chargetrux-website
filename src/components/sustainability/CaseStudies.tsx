...
const CaseStudies = () => {
  const caseStudies = [{
    ...
    stats: [{
      value: "12%",
      label: "Daily Uptime Recovery"
    }, {
      value: "27%",
      label: "Reduction in Charging Costs"
    }, {
      value: "142",
    ...
    results: ["<strong>Recovered 12% daily uptime</strong> by eliminating return trips to the central depot for charging", "<strong>Increased delivery capacity</strong> by extending effective range of each vehicle", "<strong>Reduced charging infrastructure costs</strong> by avoiding installation of permanent charging stations", "<strong>Eliminated charging bottlenecks</strong> during peak operational periods", "<strong>Improved driver satisfaction</strong> with more predictable schedules and reduced range anxiety"],
    ...
    stats: [{
      value: "18%",
      label: "Reduction in Processing Bottlenecks"
    }, {
      value: "45",
      label: "Minutes Average Time Saved Per Vehicle"
    }, {
      value: "32%",
      label: "Increase in EV Availability"
    }],
    ...
    results: ["<strong>Reduced EV processing bottlenecks by 18%</strong> through additional charging capacity", "<strong>Decreased average turnaround time</strong> for returned electric vehicles", "<strong>Improved fleet utilization</strong> with faster processing of returned vehicles", "<strong>Enhanced customer satisfaction</strong> due to increased availability of fully-charged EVs", "<strong>Achieved sustainability goals</strong> with 100% renewable energy charging"],
    ...
    stats: [{
      value: "24/7",
      label: "Clean Truck Compliance"
    }, {
      value: "100%",
      label: "Operational Continuity"
    }, {
      value: "0",
      label: "Emissions During Construction"
    }],
    ...
    results: ["<strong>Enabled 24/7 clean truck compliance</strong> during fixed-station construction", "<strong>Maintained operational continuity</strong> throughout infrastructure transition", "<strong>Provided flexible charging capacity</strong> that scaled with growing fleet needs", "<strong>Eliminated construction delays</strong> related to charging availability", "<strong>Supported emissions reduction targets</strong> with 100% renewable energy"],
  ...
  return <section className="py-16 bg-gradient-to-br from-[#f7f7f7] to-white">

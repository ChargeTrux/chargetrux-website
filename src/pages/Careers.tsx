...
const Careers = () => {
  ...
  const positions = [...westCoastPositions, ...gulfCoastPositions, ...eastCoastPositions];
  return <div className="min-h-screen bg-gradient-to-b from-chargetrux-darkblue to-black">
      <Navbar />
      <div className="container mx-auto px-4 py-16 pt-24">
        ...
        duration: 0.6
          ...
          <div className="mb-10">
            ...
            {westCoastPositions.length > 0 ? <div className="grid gap-4">
                {westCoastPositions.map((position, index) => <motion.div key={`west-pos-${index}`} className="bg-chargetrux-darkblue/60 border border-gray-700 rounded-lg p-6 hover:border-chargetrux-blue transition-all" whileHover={{
              scale: 1.01
            }}>
              ...
              </div> : <p className="text-gray-400 bg-chargetrux-darkblue/40 p-4 rounded-lg">No current positions available in this region.</p>}
          </div>
          ...
          <div className="mb-10">
            ...
            {gulfCoastPositions.length > 0 ? <div className="grid gap-4">
                {gulfCoastPositions.map((position, index) => <motion.div key={`gulf-pos-${index}`} className="bg-chargetrux-darkblue/60 border border-gray-700 rounded-lg p-6 hover:border-chargetrux-blue transition-all" whileHover={{
              scale: 1.01
            }}>
                    <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                      <div>
          ...
          <div className="mb-10">
            ...
            {eastCoastPositions.length > 0 ? <div className="grid gap-4">
                {eastCoastPositions.map((position, index) => <motion.div key={`east-pos-${index}`} className="bg-chargetrux-darkblue/60 border border-gray-700 rounded-lg p-6 hover:border-chargetrux-blue transition-all" whileHover={{
              scale: 1.01
            }}>
                    <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                      <div>

  ...
  return (
    <div className="bg-gradient-to-b from-white to-gray-50 min-h-screen">
      ...
      <div className="container mx-auto px-4 pt-24 pb-16">
        ...
        >
          <h1 className="text-3xl md:text-5xl font-bold text-chargetrux-darkblue mb-6">
            Transparent EV Charging Pricing For Fleets
          </h1>
          <div className="w-24 h-1.5 bg-chargetrux-green mx-auto mb-8"></div>
          <p className="text-xl text-chargetrux-darkblue max-w-3xl mx-auto font-medium">
        ...
        <section className="mb-24">
          <motion.h2 
            ...
            viewport={{ once: true }}
            className="text-2xl md:text-4xl font-bold text-center text-chargetrux-darkblue mb-6"
          >
                ...
                <CardContent className="pt-6">
                  ...
                  <div className="mt-8 pt-4 border-t border-gray-100">
                    <p className="font-medium text-chargetrux-darkblue">
                      Ideal for: <span className="font-normal text-gray-600">Regular depot charging, scheduled routes, predictable energy needs</span>
                    </p>
                  </div>
                </CardContent>
              </Card>
            ...
            >
              <Card className="h-full border-2 border-gray-100 hover:border-chargetrux-blue transition-all duration-300 overflow-hidden shadow-sm hover:shadow-lg">
                ...
                <CardContent className="pt-6">
                  ...
                  <div className="mt-8 pt-4 border-t border-gray-100">
                    <p className="font-medium text-chargetrux-darkblue">
                      Ideal for: <span className="font-normal text-gray-600">Delivery fleets with holiday surges, tourism operations, agricultural transport</span>
                    </p>
                  </div>
                </CardContent>
              </Card>
            ...
            >
              <Card className="h-full border-2 border-gray-100 hover:border-chargetrux-blue transition-all duration-300 overflow-hidden shadow-sm hover:shadow-lg">
                ...
                <CardContent className="pt-6">
                  ...
                  <div className="mt-8 pt-4 border-t border-gray-100">
                    <p className="font-medium text-chargetrux-darkblue">
                      Ideal for: <span className="font-normal text-gray-600">Occasional charging needs, emergency backup, supplemental capacity</span>
                    </p>
                  </div>
                </CardContent>
              </Card>
            ...
            >
              <Card className="h-full border-2 border-chargetrux-green bg-gradient-to-br from-white to-green-50 hover:shadow-lg transition-shadow duration-300 overflow-hidden">
                ...
                <CardContent className="pt-6">
                  ...
                  <div className="mt-8 pt-4 border-t border-gray-100">
                    <p className="font-medium text-chargetrux-darkblue">
                      Ideal for: <span className="font-normal text-gray-600">Large fleets, multi-city operations, specialized vehicle requirements</span>
                    </p>
                  </div>
                </CardContent>
              </Card>
